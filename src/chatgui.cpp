    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>(); // Instantiate the ChatLogic and wrap it into a unique pointer 
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // delete _chatLogic; //Not needed anymore, the destructor of the SmartPointer is called after going out of scope and it relases the memory
